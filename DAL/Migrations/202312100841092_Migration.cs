namespace DAL.Migrations
{
    ...
    public partial class Migration : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        AccountName = c.String(maxLength: 30, unicode: false),
                ...
                c => new
                    {
                        ...
                        IDTK = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.ACCOUNT", t => t.IDTK, cascadeDelete: true)
                .Index(t => t.IDTK);
                ...
                c => new
                    {
                        ...
                        DateOfBirth = c.DateTime(nullable: false),
                        Phone = c.String(maxLength: 10, unicode: false),
                        Point = c.String(maxLength: 10, unicode: false),
                        Address = c.String(maxLength: 100),
                        Email = c.String(maxLength: 100, unicode: false),
                        Image = c.String(maxLength: 8000, unicode: false),
                        IDTK = c.Int(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.USERS", "IDTK", "dbo.ACCOUNT");
            DropForeignKey("dbo.BILL_OFFLINE", "CreatedBy", "dbo.EMPLOYEES");
            DropForeignKey("dbo.EMPLOYEES", "IDTK", "dbo.ACCOUNT");
            DropForeignKey("dbo.ACCOUNT", "Role", "dbo.ROLES");
            ...
            DropIndex("dbo.USERS", new[] { "IDTK" });
            DropIndex("dbo.EMPLOYEES", new[] { "IDTK" });
            ...
            DropIndex("dbo.ACCOUNT", new[] { "Role" });
